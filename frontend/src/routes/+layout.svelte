    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <svg
                            class="hi-mini hi-cube-transparent inline-block h-5 w-5 text-indigo-600 transition group-hover:scale-110 dark:text-indigo-400"
                ...
                <div class="lg:hidden">
                    ...
                    >
                        <svg
                                class="hi-mini hi-x-mark -mx-0.5 inline-block h-5 w-5"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                                aria-hidden="true"
            ...
            <div class="overflow-y-auto">
                <div class="w-full p-4">
                    <nav class="space-y-1">
                            <MenuItem name="Dashboard (TBD)" link="/dashboard"/>
                            <div
                                    class="px-3 pb-2 pt-5 text-xs font-semibold uppercase tracking-wider text-gray-500"
                            >
                                Core functions
                            </div>
                            <MenuItem name="Array Wizard" link="/tool/wizard"/>
                            <MenuItem name="Quotes (TBD)" link="/quotes/list"/>
                            <div
                                    class="px-3 pb-2 pt-5 text-xs font-semibold uppercase tracking-wider text-gray-500"
                            >
                                Database
                            </div>
                            <MenuItem name="Parts" link="/tool/parts/list"/>
                            <MenuItem name="Roof Types" link="/tool/type/list"/>
                            <MenuItem name="Roof Sheets" link="/tool/sheet/list"/>
                    </nav>
                </div>
            </div>
                            ...
                            >
                                <div class="space-y-1 p-2.5">
                                    <a
                                            role="menuitem"
                                            href="javascript:void(0)"
                                            class="group flex items-center justify-between space-x-2 rounded-lg border border-transparent px-2.5 py-2 text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-800 active:border-indigo-100 dark:text-gray-200 dark:hover:bg-gray-700/75 dark:hover:text-white dark:active:border-gray-600"
                                    >
                                        <svg
                                                class="hi-mini hi-inbox inline-block h-5 w-5 flex-none opacity-25 group-hover:opacity-50"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                                aria-hidden="true"
                                        ...
                                        <div
                                                class="inline-flex rounded-full border border-indigo-200 bg-indigo-100 px-1.5 py-0.5 text-xs font-semibold leading-4 text-indigo-700 dark:border-indigo-700 dark:bg-indigo-700 dark:text-indigo-50"
                                        >
                                            2
                                        </div>
                                    </a>
                                    ...
                                    >
                                        <svg
                                                class="hi-mini hi-flag inline-block h-5 w-5 flex-none opacity-25 group-hover:opacity-50"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                                aria-hidden="true"
                                ...
                                <div class="space-y-1 p-2.5">
                                    ...
                                    >
                                        <svg
                                                class="hi-mini hi-user-circle inline-block h-5 w-5 flex-none opacity-25 group-hover:opacity-50"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                                aria-hidden="true"
                                    ...
                                    >
                                        <svg
                                                class="hi-mini hi-cog-6-tooth inline-block h-5 w-5 flex-none opacity-25 group-hover:opacity-50"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                                aria-hidden="true"
                                ...
                                <div class="space-y-1 p-2.5">
                                    <form on:submit={() => false}>
                                        <button
                                                type="submit"
                                                role="menuitem"
                                                class="group flex w-full items-center justify-between space-x-2 rounded-lg border border-transparent px-2.5 py-2 text-left text-sm font-medium text-gray-700 hover:bg-indigo-50 hover:text-indigo-800 active:border-indigo-100 dark:text-gray-200 dark:hover:bg-gray-700/75 dark:hover:text-white dark:active:border-gray-600"
                                        >
                                            <svg
                                                    class="hi-mini hi-lock-closed inline-block h-5 w-5 flex-none opacity-25 group-hover:opacity-50"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 20 20"
                                                    fill="currentColor"
                                                    aria-hidden="true"
        ...
        <footer
                id="page-footer"
                class="flex flex-none items-center bg-white dark:bg-gray-800 dark:bg-opacity-50"
        >
            <div
